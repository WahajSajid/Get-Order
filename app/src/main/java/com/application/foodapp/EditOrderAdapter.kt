...
class EditOrderAdapter(private val orderItems:ArrayList<OrderItems>,private val onDeleteItem:(OrderItems) -> Unit):RecyclerView.Adapter<EditOrderAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.orderItemName.text = items.name
